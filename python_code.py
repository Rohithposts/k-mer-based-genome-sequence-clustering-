...
frequency = [kmer_frequency(seq, 4) for seq in sequences]    #.................................1
...
def dendrogram_generator(counts, distance, linkage_method, counts_type):
    ...
    plt.title(f"{distance} distance , {linkage_method} linkage, {counts_type} counts, k = 4")
    plt.show()
    return Z
...
def ari(Z1, Z2):
    ...
    return ari
#ari values for k=4, 5  (change the value of k in appending_the_sequences.py to 4 or 5 as and when needed)
